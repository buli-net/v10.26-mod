...
# chỉ tải commandline-tools, chưa cài platform
...
# CÀI SDK + BUILD trong cùng 1 RUN với cache mount
RUN --mount=target=/home/builder/android-sdk,type=cache,uid=1000 \
    --mount=target=/home/builder/.gradle,type=cache,uid=1000 \
    yes | sdkmanager --licenses > /dev/null && \
    sdkmanager "platform-tools" "platforms;android-34" "build-tools;35.0.0" > /dev/null && \
